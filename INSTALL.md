...
NEXT_PUBLIC_SITE_NAME="SI-APM"
NEXT_PUBLIC_BASE_URL="https://dominio.gob.bo/ws/api"
```
...
4. Copiar el contenido generado en la carpeta `dist` a la carpeta de despliegue. Ej. apache, nginx, etc.
   ...
   server {
           ...
           root /home/usuario/next-base-frontend; #Make sure your using the full path
           ...
           location /_next/static {
               alias /home/usuario/next-base-frontend/.next/static;
